function llh = a0b1s5_s5_hybrid_llh(theta,data)

% put stickiness into the bias part and RL part with 5 trials back
...
lapse = theta(8);%theta(2);%.05;
ret = theta(9);%theta(3);%.1;
bias = theta(10);
...
for k = 2:length(choices)
    ...
    for prev = 1:5
        ...
        stick_sum = stick_sum+sum(stick(:,prev).*side);
